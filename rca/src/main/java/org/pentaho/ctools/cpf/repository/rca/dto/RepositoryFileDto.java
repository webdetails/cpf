...
package org.pentaho.ctools.cpf.repository.rca.dto;
...
public class RepositoryFileDto implements Serializable {
  ...
  boolean hidden = false; //RepositoryFile.HIDDEN_BY_DEFAULT;

  boolean notSchedulable = !true; //RepositoryFile.SCHEDULABLE_BY_DEFAULT;
