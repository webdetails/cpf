...
public class InterPluginCallTest {
  ...
  public class BeanTest {
    ...
    public class AnyObjectWithToStringOverridden {
      @Override
    ...
    public class AnyObjectWithToStringNotOverridden {
    }
  ...
  private void initializeInterPluginCallForTesting( String method ) {
    ...
    interPluginCall = Mockito.spy( ipc );
  ...
  public void testCallingMethodReturningResponse() {
    ...
    Assert.assertEquals( TEST_RESULT_STRING, actualResult );
  }
