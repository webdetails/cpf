...
//XXX temporarily disabled, bring back in some form
public class MinificationPackageTest extends TestCase {

  private static final String fancyBoxIECss =
      ".fancybox-ie6 #fancybox-close { background: transparent; filter: progid:DXImageTransform.Microsoft"
        ...
        + ".fancybox-ie #fancybox-bg-n { filter: progid:DXImageTransform.Microsoft.AlphaImageLoader"
        + "(src='fancybox/fancy_shadow_n.png', sizingMethod='scale'); }\n";
  ...
  public void testBogus() {
    assertTrue( "tautology exception", true );
  }
  ...
  //        new String[] {"url('../js/fancybox/fancybox.png')",
  //                      "(src='../js/fancybox/../fancybox/fancy_shadow_n.png'"});//  just don't think too much
  // about it
