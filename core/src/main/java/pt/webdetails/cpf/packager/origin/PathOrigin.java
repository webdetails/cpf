...
/**
 * To keep track of file origin <u>within the same plugin</u>.<br> Everything needed to reinstantiate a Plugin's
 * IReadAccess, and translate its location to a url.<br>
 */
public abstract class PathOrigin {
  ...
  public boolean equals( Object other ) {
    return
      other instanceof PathOrigin && getClass().equals( other.getClass() )
